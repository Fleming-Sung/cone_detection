'''
To train the cone detection model with YOLO
Fleming@Jan.1st.2023
'''
...
"""
to spilt dataset:
paddlex --split_dataset --format VOC --dataset_dir ./cone_det --val_value 0.2 --test_value 0.1
"""
...
train_dataset = pdx.datasets.VOCDetection(
    data_dir='cone_det',
    file_list='cone_det/train_list.txt',
    label_list='cone_det/labels.txt',
    transforms=train_transforms,
    shuffle=True)

eval_dataset = pdx.datasets.VOCDetection(
    data_dir='cone_det',
    file_list='cone_det/val_list.txt',
    label_list='cone_det/labels.txt',
